...
const EventCalendar: React.FC = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      eventType: 'organization',
      bureauLevel: 'Creative Directors'
    },
    {
      id: 3,
      title: 'Inter-Org Sustainability Summit',
      ...
      attendees: 200,
      category: 'activism',
      description: 'Campus-wide sustainability initiative',
      eventType: 'inter-org',
      bureauLevel: 'Presidents Council'
    },
    {
      id: 4,
    ...
    },
    {
      ...
      eventType: 'organization',
      bureauLevel: 'Performance Directors'
    },
    {
      id: 6,
      title: 'Multi-Org Career Fair',
      organization: 'Business Club + Tech Society + Engineering Guild',
      date: '2024-01-28',
      time: '10:00 AM',
  ...
  const filters = [
    ...
    { id: 'inter-org', label: 'Inter-Org Events' },
    { id: 'multi-org', label: 'Multi-Org Events' },
    { id: 'bureau', label: 'Bureau Events' },
  ...
  const getEventTypeIcon = (eventType: string) => {
    switch (eventType) {
      ...
      case 'inter-org': return <Users className="text-green-600 dark:text-green-400" size={16} />
      case 'multi-org': return <Users className="text-purple-600 dark:text-purple-400" size={16} />
      case 'bureau': return <Award className="text-orange-600 dark:text-orange-400" size={16} />
  ...
  const getEventTypeLabel = (eventType: string) => {
    switch (eventType) {
      case 'organization': return 'Organization Event'
      case 'inter-org': return 'Inter-Org Event'
      case 'multi-org': return 'Multi-Org Event'
      case 'bureau': return 'Bureau Event'
