...
const Dashboard: React.FC = () => {
  ...
  const ppmkNotifications = [
    ...
    { id: 2, type: 'meeting', message: 'Executive board meeting tomorrow at 3 PM', urgent: false },
    { id: 3, type: 'collaboration', message: 'Inter-org collaboration request from Tech Society', urgent: false }
  ]
